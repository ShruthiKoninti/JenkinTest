...
public class PaymentsVATVoucherPage extends BaseEngine 
{
	...
	public static boolean checkSavingPaymentVATVoucher1() throws InterruptedException, EncryptedDocumentException, InvalidFormatException, IOException
	{
		...
		voucherHeaderCurrency.sendKeys(excelReader.getCellData(xlSheetName, 9, 5));
		Thread.sleep(2000);
		...
		enter_AccountTxt.sendKeys(excelReader.getCellData(xlSheetName, 13, 5));
		Thread.sleep(2000);
		...
		String expBillNewReference                      =excelReader.getCellData(xlSheetName, 10, 6);
		excelReader.setCellData(xlfile, xlSheetName, 10, 7, actBillNewReference);
		
		String expBillTransactionCurrency               =excelReader.getCellData(xlSheetName, 11, 6);
		excelReader.setCellData(xlfile, xlSheetName, 11, 7, actBillTransactionCurrency);
		
		String expBillBaseCurrency                      =excelReader.getCellData(xlSheetName, 12, 6);
		excelReader.setCellData(xlfile, xlSheetName, 12, 7, actBillBaseCurrency);
		
		String expBillLocalCurrency                     =excelReader.getCellData(xlSheetName, 13, 6);
		excelReader.setCellData(xlfile, xlSheetName, 13, 7, actBillLocalCurrency);
		
		String expBillBalanceNewRefAmount               =excelReader.getCellData(xlSheetName, 14, 6);
		excelReader.setCellData(xlfile, xlSheetName, 14, 7, actBillBalanceNewRefAmount);
		
		String expbillRefAdjustAmountInTransCurency         =excelReader.getCellData(xlSheetName, 15, 6);
		excelReader.setCellData(xlfile, xlSheetName, 15, 7, actbillRefAdjustAmountInTransCurency);
		
		String expbillRefBalanceAmountAdjustInTrnasCurrency =excelReader.getCellData(xlSheetName, 16, 6);
		excelReader.setCellData(xlfile, xlSheetName, 16, 7, actbillRefBalanceAmountAdjustInTrnasCurrency);
		...
		String expBillTransactionCurrencyPick                   = excelReader.getCellData(xlSheetName, 18, 6);
		String expBillBaseCurrencyPick                          = excelReader.getCellData(xlSheetName, 19, 6);
		String expBillLocalCurrencyPick                         = excelReader.getCellData(xlSheetName, 20, 6);
		String expBillBalanceNewRefAmountPick                   = excelReader.getCellData(xlSheetName, 21, 6);
		String expbillRefAdjustAmountInTransCurencyPick         = excelReader.getCellData(xlSheetName, 22, 6);
		String expbillRefBalanceAmountAdjustInTrnasCurrencyPick = excelReader.getCellData(xlSheetName, 23, 6);
		...
		String expbreakUpDetailsAccountPick             =excelReader.getCellData(xlSheetName, 24, 6);
		excelReader.setCellData(xlfile, xlSheetName, 24, 7, actbreakUpDetailsAccountPick);
		
		String expbreakUpDetailsItemPick                =excelReader.getCellData(xlSheetName, 25, 6);
		excelReader.setCellData(xlfile, xlSheetName, 25, 7, actbreakUpDetailsItemPick);
...
/*		HashSet<String> actMessage = new HashSet();
	...
	public static boolean checkEditingPaymentVATVoucher1AndAdding2ndRow() throws InterruptedException, EncryptedDocumentException, InvalidFormatException, IOException
	{
		...
		String expDocumentNo = excelReader.getCellData(xlSheetName, 47, 6);
		excelReader.setCellData(xlfile, xlSheetName, 47, 7, actDocumentNo);

		getWebDriverWait().until(ExpectedConditions.elementToBeClickable(newCashBankAccountTxt));
		String actCashBankAccount = newCashBankAccountTxt.getAttribute("value");
		String expCashBankAccount = excelReader.getCellData(xlSheetName, 48, 6);
		excelReader.setCellData(xlfile, xlSheetName, 48, 7, actCashBankAccount);

		getFluentWebDriverWait().until(ExpectedConditions.elementToBeClickable(voucherHeaderCurrency));
		String actCurrency = voucherHeaderCurrency.getAttribute("value");
		String expCurrency = excelReader.getCellData(xlSheetName, 49, 6);
		excelReader.setCellData(xlfile, xlSheetName, 49, 7, actCurrency);

		getFluentWebDriverWait().until(ExpectedConditions.elementToBeClickable(departmentTxt));
		String actDepartment = departmentTxt.getAttribute("value");
		String expDepartment = excelReader.getCellData(xlSheetName, 50, 6);
		excelReader.setCellData(xlfile, xlSheetName, 50, 7, actDepartment);

		getFluentWebDriverWait().until(ExpectedConditions.elementToBeClickable(placeOFSupplyTxt));
		String actPlaceOfSupply = placeOFSupplyTxt.getAttribute("value");
		String expPlaceOfSupply = excelReader.getCellData(xlSheetName, 51, 6);
		excelReader.setCellData(xlfile, xlSheetName, 51, 7, actPlaceOfSupply);

		getFluentWebDriverWait().until(ExpectedConditions.elementToBeClickable(jurisdictionTxt));
		String actJurisdiction = jurisdictionTxt.getAttribute("value");
		String expJurisdiction = excelReader.getCellData(xlSheetName, 52, 6);
		excelReader.setCellData(xlfile, xlSheetName, 52, 7, actJurisdiction);

		getFluentWebDriverWait().until(ExpectedConditions.elementToBeClickable(select1stRow_1stColumn));
		String actAccount = select1stRow_1stColumn.getText();
		String expAccount = excelReader.getCellData(xlSheetName, 53, 6);
		excelReader.setCellData(xlfile, xlSheetName, 53, 7, actAccount);

		String actTaxCode = select1stRow_2ndColumn.getText();
		String expTaxCode = excelReader.getCellData(xlSheetName, 54, 6);
		excelReader.setCellData(xlfile, xlSheetName, 54, 7, actTaxCode);

		String actAmount = select1stRow_3rdColumn.getText();
		String expAmount = excelReader.getCellData(xlSheetName, 55, 6);
		excelReader.setCellData(xlfile, xlSheetName, 55, 7, actAmount);

		String actReference = select1stRow_4thColumn.getText();
		String expReference = excelReader.getCellData(xlSheetName, 56, 6);
		excelReader.setCellData(xlfile, xlSheetName, 56, 7, actReference);
		...
		enter_AccountTxt.sendKeys(excelReader.getCellData(xlSheetName, 47, 5));
		Thread.sleep(2000);
		enter_AccountTxt.sendKeys(Keys.TAB);
		...
		getFluentWebDriverWait().until(ExpectedConditions.elementToBeClickable(billRefPartyName));
		String actPartyName = billRefPartyName.getText();
		String expPartyName = excelReader.getCellData(xlSheetName, 57, 6);
		excelReader.setCellData(xlfile, xlSheetName, 58, 7, actAmount);
		...
		excelReader.setCellData(xlfile, xlSheetName, 63, 7, actBillBalanceNewRefAmount);
		...
		excelReader.setCellData(xlfile, xlSheetName, 72, 7, actbillRefBalanceAmountAdjustInTrnasCurrencyPick);
		...
		String expbreakUpDetailsAccountPick             =excelReader.getCellData(xlSheetName, 73, 6);
		excelReader.setCellData(xlfile, xlSheetName, 73, 7, actbreakUpDetailsAccountPick);
		
		String expbreakUpDetailsItemPick                =excelReader.getCellData(xlSheetName, 74, 6);
		excelReader.setCellData(xlfile, xlSheetName, 74, 7, actbreakUpDetailsItemPick);
		
		String expbreakUpDetailsDepartmentPick          =excelReader.getCellData(xlSheetName, 75, 6);
		excelReader.setCellData(xlfile, xlSheetName, 75, 7, actbreakUpDetailsDepartmentPick);
		
		//String expconversationRateBaseCurrencyRatePick  =excelReader.getCellData(xlSheetName, 76, 6);
		//excelReader.setCellData(xlfile, xlSheetName, 76, 7, actconversationRateBaseCurrencyRatePick);
		...
		excelReader.setCellData(xlfile, xlSheetName, 88, 7, actadjustmentsAmount1Pick);
		
		String expadjustmentsAmount2Pick                =excelReader.getCellData(xlSheetName, 89, 6);
		excelReader.setCellData(xlfile, xlSheetName, 89, 7, actadjustmentsAmount2Pick);
		
		String expadjustmentsAmount3Pick                =excelReader.getCellData(xlSheetName, 90, 6);
		excelReader.setCellData(xlfile, xlSheetName, 90, 7, actadjustmentsAmount3Pick);
		
		String expadjustmentsAmount4Pick                =excelReader.getCellData(xlSheetName, 91, 6);
		excelReader.setCellData(xlfile, xlSheetName, 91, 7, actadjustmentsAmount4Pick);
		
		String expexchangeGainLossForBaseCurrencyPick   =excelReader.getCellData(xlSheetName, 92, 6);
		excelReader.setCellData(xlfile, xlSheetName, 92, 7, actexchangeGainLossForBaseCurrencyPick);
		
		String expexchangeGainLossForLocalCurrencyPick  =excelReader.getCellData(xlSheetName, 93, 6);
		excelReader.setCellData(xlfile, xlSheetName, 93, 7, actexchangeGainLossForLocalCurrencyPick);
		...
		expMsg.add(excelReader.getCellData(xlSheetName, 95, 6));
		...
		String expMessage1 = excelReader.getCellData(xlSheetName, 94, 6);
		
		String actMessage = checkValidationMessage(expMessage1);
		String expMessage2 = excelReader.getCellData(xlSheetName, 95, 6);
	...
	public static boolean checkSavingPaymentVATVoucher2() throws InterruptedException, EncryptedDocumentException, InvalidFormatException, IOException
	{
		...
		getWebDriverWait().until(ExpectedConditions.elementToBeClickable(newCashBankAccountTxt));
		newCashBankAccountTxt.click();
		newCashBankAccountTxt.sendKeys(excelReader.getCellData(xlSheetName, 96, 5));
		Thread.sleep(2000);
		newCashBankAccountTxt.sendKeys(Keys.TAB);
		...
		departmentTxt.click();
		departmentTxt.sendKeys(Keys.SHIFT,Keys.HOME,Keys.BACK_SPACE);
		departmentTxt.sendKeys(excelReader.getCellData(xlSheetName, 98, 5));
		Thread.sleep(2000);
		departmentTxt.sendKeys(Keys.TAB);

		getFluentWebDriverWait().until(ExpectedConditions.elementToBeClickable(placeOFSupplyTxt));
		placeOFSupplyTxt.click();
		placeOFSupplyTxt.sendKeys(excelReader.getCellData(xlSheetName, 99, 5));
		Thread.sleep(2000);
		placeOFSupplyTxt.sendKeys(Keys.TAB);
		...
		select1stRow_1stColumn.click();
		getFluentWebDriverWait().until(ExpectedConditions.elementToBeClickable(enter_AccountTxt));
		enter_AccountTxt.sendKeys(excelReader.getCellData(xlSheetName, 101, 5));
		Thread.sleep(2000);
		enter_AccountTxt.sendKeys(Keys.TAB);
		...
		getFluentWebDriverWait().until(ExpectedConditions.elementToBeClickable(billRefPartyName));
		String actPartyName = billRefPartyName.getText();
		String expPartyName = excelReader.getCellData(xlSheetName, 96, 6);
		excelReader.setCellData(xlfile, xlSheetName, 96, 7, actPartyName);
		...
		String expBillNewReference                      =excelReader.getCellData(xlSheetName, 98, 6);
		excelReader.setCellData(xlfile, xlSheetName, 98, 7, actBillNewReference);
		
		String expBillTransactionCurrency               =excelReader.getCellData(xlSheetName, 99, 6);
		excelReader.setCellData(xlfile, xlSheetName, 99, 7, actBillTransactionCurrency);
		
		String expBillBaseCurrency                      =excelReader.getCellData(xlSheetName, 100, 6);
		excelReader.setCellData(xlfile, xlSheetName, 100, 7, actBillBaseCurrency);
		
		String expBillLocalCurrency                     =excelReader.getCellData(xlSheetName, 101, 6);
		excelReader.setCellData(xlfile, xlSheetName, 101, 7, actBillLocalCurrency);
		
		String expBillBalanceNewRefAmount               =excelReader.getCellData(xlSheetName, 102, 6);
		excelReader.setCellData(xlfile, xlSheetName, 102, 7, actBillBalanceNewRefAmount);
		
		String expbillRefAdjustAmountInTransCurency         =excelReader.getCellData(xlSheetName, 103, 6);
		excelReader.setCellData(xlfile, xlSheetName, 103, 7, actbillRefAdjustAmountInTransCurency);
		
		String expbillRefBalanceAmountAdjustInTrnasCurrency =excelReader.getCellData(xlSheetName, 104, 6);
		excelReader.setCellData(xlfile, xlSheetName, 104, 7, actbillRefBalanceAmountAdjustInTrnasCurrency);
		...
		String expBillNewReferencePick                          = excelReader.getCellData(xlSheetName, 105, 6);
		excelReader.setCellData(xlfile, xlSheetName, 105, 7, actBillNewReferencePick);
		
		String expBillTransactionCurrencyPick                   = excelReader.getCellData(xlSheetName, 106, 6);
		excelReader.setCellData(xlfile, xlSheetName, 106, 7, actBillTransactionCurrencyPick);
		
		String expBillBaseCurrencyPick                          = excelReader.getCellData(xlSheetName, 107, 6);
		excelReader.setCellData(xlfile, xlSheetName, 107, 7, actBillBaseCurrencyPick);
		
		String expBillLocalCurrencyPick                         = excelReader.getCellData(xlSheetName, 108, 6);
		excelReader.setCellData(xlfile, xlSheetName, 108, 7, actBillLocalCurrencyPick);
		
		String expBillBalanceNewRefAmountPick                   = excelReader.getCellData(xlSheetName, 109, 6);
		excelReader.setCellData(xlfile, xlSheetName, 109, 7, actBillBalanceNewRefAmountPick);
		
		String expbillRefAdjustAmountInTransCurencyPick         = excelReader.getCellData(xlSheetName, 110, 6);
		excelReader.setCellData(xlfile, xlSheetName, 110, 7, actbillRefAdjustAmountInTransCurencyPick);
		
		String expbillRefBalanceAmountAdjustInTrnasCurrencyPick = excelReader.getCellData(xlSheetName, 111, 6);
		excelReader.setCellData(xlfile, xlSheetName, 111, 7, actbillRefBalanceAmountAdjustInTrnasCurrencyPick);
		...
		String expbreakUpDetailsAccountPick             =excelReader.getCellData(xlSheetName, 112, 6);
		excelReader.setCellData(xlfile, xlSheetName, 112, 7, actbreakUpDetailsAccountPick);
		
		String expbreakUpDetailsItemPick                =excelReader.getCellData(xlSheetName, 113, 6);
		excelReader.setCellData(xlfile, xlSheetName, 113, 7, actbreakUpDetailsItemPick);
		
		String expbreakUpDetailsDepartmentPick          =excelReader.getCellData(xlSheetName, 114, 6);
		excelReader.setCellData(xlfile, xlSheetName, 114, 7, actbreakUpDetailsDepartmentPick);
		
		//String expconversationRateBaseCurrencyRatePick  =excelReader.getCellData(xlSheetName, 115, 6);
		//excelReader.setCellData(xlfile, xlSheetName, 115, 7, actconversationRateBaseCurrencyRatePick);
		...
		excelReader.setCellData(xlfile, xlSheetName, 127, 7, actadjustmentsAmount1Pick);
		
		String expadjustmentsAmount2Pick                =excelReader.getCellData(xlSheetName, 128, 6);
		excelReader.setCellData(xlfile, xlSheetName, 128, 7, actadjustmentsAmount2Pick);
		
		String expadjustmentsAmount3Pick                =excelReader.getCellData(xlSheetName, 129, 6);
		excelReader.setCellData(xlfile, xlSheetName, 129, 7, actadjustmentsAmount3Pick);
		
		String expadjustmentsAmount4Pick                =excelReader.getCellData(xlSheetName, 130, 6);
		excelReader.setCellData(xlfile, xlSheetName, 130, 7, actadjustmentsAmount4Pick);

		String expexchangeGainLossForBaseCurrencyPick   =excelReader.getCellData(xlSheetName, 131, 6);
		excelReader.setCellData(xlfile, xlSheetName, 131, 7, actexchangeGainLossForBaseCurrencyPick);
		
		String expexchangeGainLossForLocalCurrencyPick  =excelReader.getCellData(xlSheetName, 132, 6);
		excelReader.setCellData(xlfile, xlSheetName, 132, 7, actexchangeGainLossForLocalCurrencyPick);
		...
		expMsg.add(excelReader.getCellData(xlSheetName, 133, 6));
		expMsg.add(excelReader.getCellData(xlSheetName, 134, 6));
...
String expMessage1 = excelReader.getCellData(xlSheetName, 133, 6);
		
		String actMessage = checkValidationMessage(expMessage1);
		String expMessage2 = excelReader.getCellData(xlSheetName, 134, 6);
	...
	public static boolean checkVerifyingSavedPaymentVATVoucher2AndDeleting() throws InterruptedException, EncryptedDocumentException, InvalidFormatException, IOException
	{
		...
		getWebDriverWait().until(ExpectedConditions.elementToBeClickable(documentNumberTxt));
		String actDocumentNo = documentNumberTxt.getAttribute("value");
		String expDocumentNo = excelReader.getCellData(xlSheetName, 135, 6);
		excelReader.setCellData(xlfile, xlSheetName, 135, 7, actDocumentNo);

		getWebDriverWait().until(ExpectedConditions.elementToBeClickable(newCashBankAccountTxt));
		String actCashBankAccount = newCashBankAccountTxt.getAttribute("value");
		String expCashBankAccount = excelReader.getCellData(xlSheetName, 136, 6);
		excelReader.setCellData(xlfile, xlSheetName, 136, 7, actCashBankAccount);
		
		getFluentWebDriverWait().until(ExpectedConditions.elementToBeClickable(voucherHeaderCurrency));
		String actCurrency = voucherHeaderCurrency.getAttribute("value");
		String expCurrency = excelReader.getCellData(xlSheetName, 137, 6);
		excelReader.setCellData(xlfile, xlSheetName, 137, 7, actCurrency);

		getFluentWebDriverWait().until(ExpectedConditions.elementToBeClickable(departmentTxt));
		String actDepartment = departmentTxt.getAttribute("value");
		String expDepartment = excelReader.getCellData(xlSheetName, 138, 6);
		excelReader.setCellData(xlfile, xlSheetName, 138, 7, actDepartment);

		getFluentWebDriverWait().until(ExpectedConditions.elementToBeClickable(placeOFSupplyTxt));
		String actPlaceOfSupply = placeOFSupplyTxt.getAttribute("value");
		String expPlaceOfSupply = excelReader.getCellData(xlSheetName, 139, 6);
		excelReader.setCellData(xlfile, xlSheetName, 139, 7, actPlaceOfSupply);

		getFluentWebDriverWait().until(ExpectedConditions.elementToBeClickable(jurisdictionTxt));
		String actJurisdiction = jurisdictionTxt.getAttribute("value");
		String expJurisdiction = excelReader.getCellData(xlSheetName, 140, 6);
		excelReader.setCellData(xlfile, xlSheetName, 140, 7, actJurisdiction);

		getFluentWebDriverWait().until(ExpectedConditions.elementToBeClickable(select1stRow_1stColumn));
		String actAccount = select1stRow_1stColumn.getText();
		String expAccount = excelReader.getCellData(xlSheetName, 141, 6);
		excelReader.setCellData(xlfile, xlSheetName, 141, 7, actAccount);

		String actTaxCode = select1stRow_2ndColumn.getText();
		String expTaxCode = excelReader.getCellData(xlSheetName, 142, 6);
		excelReader.setCellData(xlfile, xlSheetName, 142, 7, actTaxCode);

		String actAmount = select1stRow_3rdColumn.getText();
		String expAmount = excelReader.getCellData(xlSheetName, 143, 6);
		excelReader.setCellData(xlfile, xlSheetName, 143, 7, actAmount);

		String actReference = select1stRow_4thColumn.getText();
		String expReference = excelReader.getCellData(xlSheetName, 144, 6);
		excelReader.setCellData(xlfile, xlSheetName, 144, 7, actReference);
	...
	public boolean checkVerifingDetailsOfSavedPaymentVATVoucherInHomepage() throws EncryptedDocumentException, InvalidFormatException, IOException, InterruptedException
	{
		...
		expVouchersList.add(excelReader.getCellData(xlSheetName, 146, 6));
		expVouchersList.add(currentDate);
		expVouchersList.add(excelReader.getCellData(xlSheetName, 147, 6));
		expVouchersList.add(excelReader.getCellData(xlSheetName, 148, 6));
		expVouchersList.add(excelReader.getCellData(xlSheetName, 149, 6));
		expVouchersList.add(currentDate);
		expVouchersList.add(currentDate);
		expVouchersList.add(excelReader.getCellData(xlSheetName, 150, 6));
		expVouchersList.add(excelReader.getCellData(xlSheetName, 151, 6));
		expVouchersList.add(excelReader.getCellData(xlSheetName, 152, 6));
		expVouchersList.add(excelReader.getCellData(xlSheetName, 153, 6));

		excelReader.setCellData(xlfile, xlSheetName, 146, 7, actVouchersList.toString());
